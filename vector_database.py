...
pdfs_directory="pdfs/"
def upload_pdfs(file): # this func store the uploaded pdf files by user into our pdfs directory 
    with open(pdfs_directory + file.name, "wb") as f:
        f.write(file.getbuffer())

def load_pdf(file_path): # this func loads the text written in that pdf's and stores in the db
...
# print("Chunks counts: ",len(text_chunks))
